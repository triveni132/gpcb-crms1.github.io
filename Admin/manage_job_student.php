...
<html>
<head>
	<title>Manage job Students</title>
	<?php
...
<table border="1px;" align="center">
	...
	while($row = mysqli_fetch_assoc($result))
	{
		...
		<td align="center"><a href="delete_job_stu_for_tpo.php?id=<?php echo $row["id"]; ?>"><input type="button" name="delete" value="Delete" onclick="f();"></a></td>
