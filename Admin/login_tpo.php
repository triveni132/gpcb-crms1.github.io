...
<?php
    ...
    //Checking is user existing in the database or not
        $query = "SELECT * FROM `registration_tpo` WHERE email='$email' and password='$password'";
        $result = mysqli_query($con,$query) or die(mysqli_error());
        $rows = mysqli_num_rows($result);
        if($rows==1){
            $_SESSION['email'] = $email;
            header("Location: after_login_tpo.php"); // Redirect user to index.php
            }
            else{
                echo "<div class='form'><h3>Email-id/password is incorrect.</h3><br/>Click here to <a href='login_tpo.php'>Login</a></div>";
                }
    }else{
?>
 <center>
        <div class="form">
            <fieldset style="background-color:  white; height: 400px; width: 450px; padding: 20px; margin: 100px;">
                <legend></legend>
                <h1 style="color: indigo;" class="hr">LOGIN TPO</h1>
                ...
                <form action="" method="post" name="login">
                    ...
                    <table>
                        ...
                        <td><a href="forgot_password.php">Forgot password</a></td>
                           ...
                           <tr>
                            <td><p>Not registered yet? <a href='registration_tpo.php'>Register Here</a></p></td>
                           </tr>
                    </table>
                   </center>
                </form>
