...
<table border="1px;" align="center">
  ...
  while($row = mysqli_fetch_assoc($result))
  {
   ...
   <td align="center"><a href="update_training.php?id=<?php echo $row["id"]; ?>"><input type="button" name="update" value="Update" onclick="f();"></a></td>
  
    <td align="center"><a href="delete_training.php?id=<?php echo $row["id"]; ?>"><input type="button" name="delete" value="Delete" onclick="f();"></a></td>
