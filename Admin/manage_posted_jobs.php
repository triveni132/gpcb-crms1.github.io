...
<table border="1px;" align="center">
	...
	while($row = mysqli_fetch_assoc($result))
	{
		...
		<td align="center"><a href="delete_posted_jobs.php" id=<?php echo $row["id"]; ?>"><input type="button" name="delete" value="Delete" onclick="f();"></a></td>
