...
<div class="admin">
  <b><a href="admin_login.php" class="ad">Admin</a></b>
</div><br><br>
...
<?php
    ...
    //Checking is user existing in the database or not
        $query = "SELECT * FROM admin_login WHERE login_id='$login_id' and password='$password'";
        $result = mysqli_query($con,$query) or die(mysqli_error());
        $rows = mysqli_num_rows($result);
        if($rows==1){
            $_SESSION['login_id'] = $login_id;
            header("Location: after_login_admin.php"); // Redirect user to index.php
            }
            else{
                echo "<div class='form'><h3>Enrollment Number/password is incorrect.</h3><br/>Click here to <a href='admin_login.php'>Login</a></div>";
                }
    }else{
?>
 <center>
        <div class="form">
            <fieldset style="background-color:  white; height: 400px; width: 550px; padding: 20px; margin: 100px;">
                <legend></legend>
                <h1 style="color: indigo;" class="hr">ADMINISTRATIVE LOGIN </h1>
                ...
                <form action="" method="post" name="login">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>Login Id : </td>
                            <td><input type="text" name="login_id" placeholder="Enter Your login id" required /></td>
                        </tr>
