...
<head>
<meta charset="utf-8">
<title>Login Student for Training</title>
<style>
...
<div class="admin">
  <b><a href="Admin/admin_login.php">Admin</a></b>
</div><br><br>
...
<?php
    ...
    if (isset($_POST['enrollment_num'])){
        
        $enrollment_num = $_REQUEST['enrollment_num']; 
        $password = $_REQUEST['password'];
        
    //Checking is user existing in the database or not
        $query = "SELECT * FROM registration_for_training WHERE enrollment_num='$enrollment_num' and password='$password'";
        $result = mysqli_query($con,$query) or die(mysqli_error());
        $rows = mysqli_num_rows($result);
        if($rows==1){
            $_SESSION['enrollment_num'] = $enrollment_num;
           header("Location: after_login_student_training.php"); // Redirect user to index.php
            }
            else{
                echo "<div class='form'><h3>Enrollment Number/password is incorrect.</h3><br/>Click here to <a href='login_student_for_training.php'>Login</a></div>";
                }
    }else{
?>
 <center>
        <div class="form">
            <fieldset style="background-color:  white; height: 400px; width: 550px; padding: 20px; margin: 100px;">
                <legend></legend>
                <h1 style="color: indigo;" class="hr">LOGIN STUDENT FOR TRAINING</h1>
                ...
                <form action="" method="post" name="login">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="enrollment_num" placeholder="Enter Your Enrollment Number" required /></td>
                        </tr>
                    ...
                    <table>
                        ...
                        <td><a href="forgot_password.php">Forgot password</a></td>
                           ...
                           <tr>
                            <td><p>Not registered yet? <a href='registration_student_for_training.php'>Register Here</a></p></td>
                           </tr>
                    </table>
                   </center>
                </form>
