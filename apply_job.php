...
<table  class="form">
        <tr>
             <td> Company Name:
             <td><input type="hidden" name="company_name"  value="<?php echo $row['company_name']; ?>"><input type="text"  name="company_name"  value="<?php echo $row['company_name']; ?>"></td>
        </tr>
          <tr>
             <td> Job Title :
        ...
        <tr>
         ...
         <input type="submit" name="submit" value="Apply" onclick="f();">
</form>
</center> 
